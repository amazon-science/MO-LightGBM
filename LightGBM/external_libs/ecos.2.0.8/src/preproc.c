...
//    PRINTTEXT("ECOS: mywork malloc done") ;
...
//    PRINTTEXT("ECOS: mywork num assignment done") ;
...
//        PRINTTEXT("Memory allocated for LPCONE\n");
#if PRINTLEVEL > 2
...
//    PRINTTEXT("Memory allocated for SOCONE\n");
...
//    PRINTTEXT("Done setting A and G \n");
